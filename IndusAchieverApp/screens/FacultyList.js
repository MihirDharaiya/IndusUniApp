...
import {getFirestore, getDocs, doc, collection, getDoc, limit, query,where} from 'firebase/firestore';
...
async function getFacultyBranch(){
  ...
  const docRef = query(collection(db,"faculty"),where("fbranch", "==", branch));
  ...
  return (
    <View style={styles.conatiner}>
       <View style={styles.titleView}>
            <Icon name="user-tie" color={Colors.grey} size={responsiveFontSize(3)}/>
      ...
      <View style={styles.buttonContainer}>
        ...
        >Other</SecondaryButton>
          ...
          <View style={{margin: 20}}>
            <Text style={styles.other}>If your respective faculty name {"\n"} is not in the available list then {"\n"} you can directly contact us via email</Text>
           <PrimaryButton
           onPress={()=>{
            Linking.openURL(
           ...
           >Connect via Email</PrimaryButton> 
           </View>
           :
        <View>
      <FlatList
